      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-6 col-md-8">
          <div class="learning_img">
                  <img src="{{ asset('img/raze.png') }}" alt="" style="max-height:400px;">
              </div>
          </div>
          <div class="col-lg-6 col-md-4">
            <div class="about_us_text">
                  <h2 style="color: white;">VAL Placement Boosting
                  </h2>
...
<section class="wrapper bg-soft-primary">
    <div class="container inner py-6 py-md-8">
      <form action="{{ route('placement.boost.order') }}" method="POST" id="val_boost_form" class="boost-form" autocomplete="off">
        @csrf
            ...
            <div class="card card-border-start border-silver" id="start_card">
              <div class="card-body">
                <div class="d-md-flex align-items-center gap-4 d-block text-start">
                    ...
                    <div>
                      <h3 class="card-title display-5 mb-2" style="color: black;">Previous Rank</h3>
                      <p class="card-text d-md-block d-none" id="start_helper_txt" style="color: black;">Please select your Previous Rank and Division.</p>
                    </div>
                  </div>
                ...
                <div class="row mt-5">
                  <div class="col-12 text-start">
                    <input class="radio-btn" type="radio" name="start_tier" value="0" id="current-unranked">
                    <label class="lift itooltip itooltip-unranked mr-2 unranked" title="Unranked" id="label-current-unranked" for="current-unranked">
                    <img class="rank-select-mini" src="{{ asset('img/boost/00.png') }}" >
                    </label>
                    ...
                    <input class="radio-btn" type="radio" name="start_tier" value="9" id="current-radiant">
                    <label class="lift itooltip itooltip-immortal mr-2 radiant" title="radiant" id="label-current-radiant" for="current-radiant">
          ...
          <div class="card sticky-lg-top card-border-start border-primary">
            <div class="card-body px-0">
              ...
              <div class="row selected-options px-6 my-3 py-3 ms-1 me-0 bg-soft-primary">
                ...
                <div class="col-4 text-center my-auto p-0">
                    <div class="rank-icon mt-1">
                    <output id="sum_matches" class="text-center games-amount-display text-primary"style="color:white;">1</output>
                    </div>
  ...
  const placementBoosts = @json($placementboosts); // Assuming placementBoosts is a JavaScript array containing the placement boost data
...
console.log(numberOfGames);
  ...
  fetch('/calculate-price-placement', {
    method: 'POST',
    headers: {
